...
namespace amg
{
  ...
  using MCS_AUX_SYS = FacetAuxSystem<3, HDivHighOrderFESpace, VectorFacetFESpace, FacetH1FE<3>>;

  template class FacetAuxSystem<3, HDivHighOrderFESpace, VectorFacetFESpace, FacetH1FE<3>>;

  using MCS_AMG_PC = FacetAuxVertexAMGPC<3, MCS_AUX_SYS, ElmatVAMG<H1AMGFactory<3>, double, double>>;
  ...
  **/
  ...
  template class FacetAuxVertexAMGPC<3, MCS_AUX_SYS, ElmatVAMG<H1AMGFactory<3>, double, double>>;
