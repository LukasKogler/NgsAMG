...
namespace amg
{
  ...
  template<NODE_TYPE NT, class TMESH, class TM>
  size_t NodalAMGFactory<NT, TMESH, TM> :: ComputeMeshMeasure (const TMESH & m) const
  {
  ...
  template<NODE_TYPE NT, class TMESH, class TM>
  double NodalAMGFactory<NT, TMESH, TM> :: ComputeLocFrac (const TMESH & m) const
  {
    /** TODO: this is used in findctrfac and is assumed to work with NT_VERTEX **/
