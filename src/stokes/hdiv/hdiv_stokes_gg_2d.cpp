...
RegisterPreconditioner<STOKES_PC> reg_stokes_hdiv_gg_2d ("NgsAMG.stokes_hdiv_gg_2d");
...
void ExportStokes_hdiv_gg_2d (py::module & m) __attribute__((visibility("default")));

void ExportStokes_hdiv_gg_2d (py::module & m)
{
  string stokes_desc = "Stokes preconditioner for grad-grad + div-div penalty in HDiv space";

  ExportStokesAMGClass<STOKES_PC> (m, "stokes_hdiv_gg_2d", stokes_desc, [&](auto & pyClass)
  {
