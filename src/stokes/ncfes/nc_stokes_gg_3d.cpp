...
RegisterPreconditioner<STOKES_PC> reg_stokes_gg_3d ("NgsAMG.stokes_gg_3d");
...
namespace amg
{
void ExportStokes_gg_3d (py::module & m) __attribute__((visibility("default")));

void ExportStokes_gg_3d (py::module & m)
{
  string stokes_desc = "Stokes preconditioner for grad-grad + div-div penalty in NC space";

  ExportStokesAMGClass<STOKES_PC> (m, "stokes_gg_3d", stokes_desc, [&](auto & pyclass) {});
} // ExportStokes_gg_3d
